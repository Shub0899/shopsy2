...
import watch from "../../assets/Product/smartwatch2-removebg-preview-cH1j5U7r.png"
...
function Banner() {
    ...
    return (
        <div className='dark:bg-[#111827] py-10'>
            <div className=''>
                <div className='flex lg:flex-row flex-col bg-green-500 rounded-3xl md:justify-between justify-start sm:items-start md:items-center md:mx-[100px] mx-[40px] md:py-[70px] py-[30px] px-[20px] gap-10' data-aos="fade-up">
                    ...
                    <div className='text sm:mx-10 sm:mx-4' data-aos="fade-up">
                        ...
                        <h1 className='uppercase text-3xl sm:text-4xl lg:text-5xl font-bold text-white'>Happy Hours
                        </h1>
                    ...
                    <div className='h-full flex items-center' data-aos="zoom-in-up"  data-aos-delay="600">
                        <img src={watch} alt="Headphone" className="scale-125 w-[250px] md:w-[340px] sm:mx-[30px] mx-auto drop-shadow-[-10px_10px_12px_rgba(0,0,0,.6)] object-cover" />
                    </div>

                    {/* Right Text Div with AOS Fade-up */}
                    <div className='text z-10 mx-4 sm:mx-10' data-aos="fade-up" >
                        <p className='text-white text-sm sm:text-base py-3'>Smart Only</p>
                        ...
                        The customer himself, the customer will be able to pursue the adipiscing of the company. And rejecting them
                        </p>
